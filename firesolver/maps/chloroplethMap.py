...
from solver.metrics import displayable_metrics
...
def generateMetricMap(saveMap, filePath):
    ...
    with urlopen(
        "https://raw.githubusercontent.com/eng-comp-2022/cec/main/data/zoneData.json"
    ) as response:
        zoneData = json.load(response)

    # Open and load the csv containing the generated risk values for each zones
    # riskData = pd.read_csv(
    #     "https://raw.githubusercontent.com/eng-comp-2022/cec/main/data/metric_output.csv",
    #     dtype={"fips": str},
    # )
